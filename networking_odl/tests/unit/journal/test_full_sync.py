...
class FullSyncTestCase(test_base_db.ODLBaseDbTestCase):
    ...
    def _get_all_resources():
        return (
            ...
            (odl_const.ODL_BGPVPN, bgpvpn_const.LABEL),
            (odl_const.ODL_BGPVPN_NETWORK_ASSOCIATION, bgpvpn_const.LABEL),
            (odl_const.ODL_BGPVPN_ROUTER_ASSOCIATION, bgpvpn_const.LABEL),
